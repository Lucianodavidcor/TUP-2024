...
const educacion = ref([
{ "fecha": "2025", "title": "Ingeniería de Sistemas Inteligentes", "descripcion": "Estudios avanzados en aprendizaje automático y sistemas de IA aplicada, con énfasis en redes neuronales y NLP.", "enlace": "https://www.iauniversity.com" },
  { "fecha": "2024", "title": "Liderazgo de Desarrollo en Blockchain", "descripcion": "Lideré proyectos en TechChain, diseñando aplicaciones descentralizadas y contratos inteligentes con Solidity y Hyperledger.", "enlace": "https://www.techchain.com" },
  { "fecha": "2023", "title": "Desarrollador de Realidad Virtual en VRWorld", "descripcion": "Trabajé en la creación de experiencias inmersivas para entrenamiento profesional, empleando Unity y Unreal Engine.", "enlace": "https://www.vrworld.com" },
  { "fecha": "2022", "title": "Proyecto Personal - App de Fintech", "descripcion": "Diseñé una aplicación para finanzas personales, con análisis de gastos y recomendaciones financieras, usando Flutter y Firebase.", "enlace": "https://www.misfinanzas.com" },
  { "fecha": "2021", "title": "Curso de Desarrollo de Videojuegos", "descripcion": "Completé un curso sobre creación de videojuegos, trabajando con diseño de niveles, mecánicas y narrativas interactivas.", "enlace": "https://www.gamingacademy.com" }
]
]);
